...
libMyPeri.a: led.o button.o buzzer.o fnd.o textlcd.o colorled.o temp.o
	arm-linux-gnueabi-ar rc libMyPeri.a led.o button.o buzzer.o fnd.o textlcd.o colorled.o temp.o
